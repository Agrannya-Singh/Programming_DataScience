...
# Function Definition
calculate_rect_ area <- function ( width , height) {
# Area = Width * Height
return ( width * height)
}
# --- Driver Code / Test Cases --area1 <- calculate_rect_ area (5 , 10)
area2 <- calculate_rect_ area (7 , 3)
area3 <- calculate_rect_ area (0 , 8)
area4 <- calculate_rect_ area (4.5 , 6.2)
# Printing Results
